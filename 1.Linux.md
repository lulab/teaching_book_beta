...
```bash
从浏览器下载：
https://www.jianguoyun.com/p/DdrDQPkQ0NLuBRiI2xk#dir=%2FYeast%20Genome%20Annotation::mode=0
...
```
**Note**：该文件已经下载好，位置在/home/cs/Bioinfo_Lab/appending/0.Linux/目录下，文件名为Saccharomyces_cerevisiae.R64-1-1.77.gtf.gz
