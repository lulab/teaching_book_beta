...
[下载链接](https://www.jianguoyun.com/p/DTCJc-gQ0NLuBRj9kQ4#dir=%2F2016%2F%E7%94%9F%E7%89%A9%E4%BF%A1%E6%81%AF%E5%AD%A6%E5%AF%BC%E8%AE%BA%2F%E4%B8%8A%E6%9C%BA%E6%96%87%E4%BB%B6%2F4.Genomics%2FYeast%20Genome%20Annotation::mode=0)

也可以从terminal下载：

```
wget http://www.ncrnalab.org/lulab/public/Saccharomyces_cerevisiae.R64-1-1.77.gtf.gz

```

> 该文件在"虚拟机"中已经下载好，位置在/home/cs/Bioinfo_Lab/appending/0.Linux/目录下，文件名为Saccharomyces_cerevisiae.R64-1-1.77.gtf.gz
...
创建一个自己的文件夹，将Saccharomyces_cerevisiae.R64-1-1.77.gtf.gz拷贝到自己的目录下，并解压缩该文件

```bash
mkdir XXX
cd XXX
cp /home/cs/Bioinfo_Lab/appending/0.Linux/Saccharomyces_cerevisiae.R64-1-1.77.gtf.gz  .
gunzip *.gtf.gz
```
> "XXX" 指创建的文件夹名称
> "." 指当前目录.
...
sort -k start[,stop] file 按照指定的字段进行排序；start指定开始处字段，

         stop指定结尾处字段；如果省略stop，默认到行尾
...
####**更多Linux命令详见参考书《“笨办法”学python》附录“命令行快速入门”，**
####**及《鸟哥的Linux私房菜－基础学习篇》(第6、7、9、10章）。**
